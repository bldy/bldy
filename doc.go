...
It uses BUILD files to create a build graph, which is then executed if a
cached version isn't available by concurrently and independent of each
other when it is able to do so.
